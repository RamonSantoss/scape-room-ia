  ...
  return (
    <section className="scene scene--lesson scene-enter">
      <div className="lesson-video-wrap">
        ...
        <div className="video-frame"><video ref={videoRef} key={currentChapter.storageUrl} controls playsInline preload="metadata" onEnded={onEnded} poster={module.coverImage}><source src={currentChapter.storageUrl} type="video/mp4" />Seu navegador não consegue reproduzir este vídeo.</video><div className="video-cover-label"><span className="live-pulse" /> SINAL DE AULA / {String(chapterIndex + 1).padStart(2, "0")}</div><div className="video-corner video-corner--tl" /><div className="video-corner video-corner--br" /></div>
